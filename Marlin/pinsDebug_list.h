...
#endif
#if defined(HEATER_0_MAX6675_SS) && HEATER_0_MAX6675_SS >= 0
  REPORT_NAME_DIGITAL(__LINE__, HEATER_0_MAX6675_SS);
#endif
#if defined(HEATER_1_MAX6675_SS) && HEATER_1_MAX6675_SS >= 0
  REPORT_NAME_DIGITAL(__LINE__, HEATER_1_MAX6675_SS);
#endif
#if defined(HEATER_2_MAX6675_SS) && HEATER_2_MAX6675_SS >= 0
  REPORT_NAME_DIGITAL(__LINE__, HEATER_2_MAX6675_SS);
#endif
#if defined(HEATER_3_MAX6675_SS) && HEATER_3_MAX6675_SS >= 0
  REPORT_NAME_DIGITAL(__LINE__, HEATER_3_MAX6675_SS);
#endif
